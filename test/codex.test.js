...
describe('Codex audit + setup', () => {
  test('codex v1.3 exposes the full 187-check catalog after adding 48 supplemental + 25 Python + 20 Go stack checks', () => {
    expect(Object.keys(CODEX_TECHNIQUES)).toHaveLength(187);
  });
